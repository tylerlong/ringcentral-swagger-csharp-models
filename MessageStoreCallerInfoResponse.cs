...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public class MessageStoreCallerInfoResponse :  IEquatable<MessageStoreCallerInfoResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageStoreCallerInfoResponse" /> class.
        /// </summary>
        public MessageStoreCallerInfoResponse()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MessageStoreCallerInfoResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as MessageStoreCallerInfoResponse);
        }

        /// <summary>
        /// Returns true if MessageStoreCallerInfoResponse instances are equal
        /// </summary>
        /// <param name="obj">Instance of MessageStoreCallerInfoResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MessageStoreCallerInfoResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.FaxErrorCode != null)
                    hash = hash * 57 + this.FaxErrorCode.GetHashCode();
