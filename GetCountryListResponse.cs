...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public class GetCountryListResponse :  IEquatable<GetCountryListResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetCountryListResponse);
        }

        /// <summary>
        /// Returns true if GetCountryListResponse instances are equal
        /// </summary>
        /// <param name="obj">Instance of GetCountryListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCountryListResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
