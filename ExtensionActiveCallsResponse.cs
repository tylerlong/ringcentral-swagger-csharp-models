...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ExtensionActiveCallsResponse :  IEquatable<ExtensionActiveCallsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtensionActiveCallsResponse" /> class.
        /// </summary>
        public ExtensionActiveCallsResponse()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExtensionActiveCallsResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ExtensionActiveCallsResponse);
        }

        /// <summary>
        /// Returns true if ExtensionActiveCallsResponse instances are equal
        /// </summary>
        /// <param name="obj">Instance of ExtensionActiveCallsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtensionActiveCallsResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
