...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public class AccountStatusInfo :  IEquatable<AccountStatusInfo>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AccountStatusInfo);
        }

        /// <summary>
        /// Returns true if AccountStatusInfo instances are equal
        /// </summary>
        /// <param name="obj">Instance of AccountStatusInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountStatusInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
