...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public class GetExtensionCallLogRecordResponse :  IEquatable<GetExtensionCallLogRecordResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetExtensionCallLogRecordResponse" /> class.
        /// </summary>
        public GetExtensionCallLogRecordResponse()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetExtensionCallLogRecordResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetExtensionCallLogRecordResponse);
        }

        /// <summary>
        /// Returns true if GetExtensionCallLogRecordResponse instances are equal
        /// </summary>
        /// <param name="obj">Instance of GetExtensionCallLogRecordResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetExtensionCallLogRecordResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
