...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public class CallLogCallerInfo :  IEquatable<CallLogCallerInfo>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CallLogCallerInfo);
        }

        /// <summary>
        /// Returns true if CallLogCallerInfo instances are equal
        /// </summary>
        /// <param name="obj">Instance of CallLogCallerInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallLogCallerInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
