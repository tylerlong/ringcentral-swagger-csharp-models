...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public class GetLocationListResponse :  IEquatable<GetLocationListResponse>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetLocationListResponse);
        }

        /// <summary>
        /// Returns true if GetLocationListResponse instances are equal
        /// </summary>
        /// <param name="obj">Instance of GetLocationListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetLocationListResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
