...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public class ExtensionCallLogResponse :  IEquatable<ExtensionCallLogResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtensionCallLogResponse" /> class.
        /// </summary>
        public ExtensionCallLogResponse()
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExtensionCallLogResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ExtensionCallLogResponse);
        }

        /// <summary>
        /// Returns true if ExtensionCallLogResponse instances are equal
        /// </summary>
        /// <param name="obj">Instance of ExtensionCallLogResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtensionCallLogResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
