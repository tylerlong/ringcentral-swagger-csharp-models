...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public class GetMessageList :  IEquatable<GetMessageList>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GetMessageList);
        }

        /// <summary>
        /// Returns true if GetMessageList instances are equal
        /// </summary>
        /// <param name="obj">Instance of GetMessageList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetMessageList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
